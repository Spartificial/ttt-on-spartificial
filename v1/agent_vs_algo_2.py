...
class CycleBalancingEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.epsilon = max(0.2, self.epsilon-.0005)
        return self.pos
...
dqn = DQNAgent(model=model, nb_actions=nb_actions, memory=memory, nb_steps_warmup=1000, enable_double_dqn=True, enable_dueling_network=False,
